drop table if exists vaccinated_state;
drop table if exists booking;
drop table if exists acquired_vaccine;
...
(
    ...
    phone_number   CHAR(13)     NOT NULL COMMENT '전화번호',
...
(
    id       INT UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'id',
    code     CHAR(2)      NOT NULL UNIQUE COMMENT '2글자 코드명 (uniqe)',
...
(
    ...
    vaccinate_at DATE         NOT NULL COMMENT '백신 접종 가능 일자',
